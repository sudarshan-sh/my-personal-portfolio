    ...
    <div className="i">
      <div className="i-left">
        <div className="i-left-wrapper">
          ...
          <h1 className="i-name">Sudarshan Sharma</h1>
          <div className="i-title">
            <div className="i-title-wrapper">
              <div className="i-title-item">Frontend/UI Developer</div>
          ...
          <p className="i-desc">
            ...
            online stores. */}
            Frontend Developer having experience of working with front-end web
            technologies to deliver exceptional customer experience. Looking
